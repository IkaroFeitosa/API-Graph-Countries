# Projeto startado com Create React App
...
Abre em [http://localhost:3000](http://localhost:3000) para vê-lo no navegador.
...
Obs.: Por conta do prazo de entrega não foi implementado 
